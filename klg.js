...
function appendPointAndU(n,w,h) {
	...
	u.push(n * 100);
	var pt = ptPrototype.cloneNode();
	pt.innerText = n;
	pts.appendChild(pt);
	adjustPointPosition(n);
	addDownListenerToPoint(n);
	
	var uInputWrapper = diabPrototype.cloneNode(true);
